        ...
        <div class="basket-product" style="padding-bottom: 60px;">
            <div class="basket-product-content">
                ...
                <div style="float: left; padding-right: 20px; padding-bottom: 20px;">
                    <a href="<%# LinkManager.GetItemUrl(GetItem(Item)) %>">
...
<div class="basket-product-actions" style="clear: both; padding-top: 20px;">
    <button runat="server" id="btnCheckout" onserverclick="btnCheckout_Click" class="btn btn-primary" style="float: right;">Checkout</button>
</div>
